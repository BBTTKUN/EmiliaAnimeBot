...
The Support group can be reached out to at [ZetBots](https://t.me/ZetBotsSupports), where you can ask for help about [Kiteretsu](https://t.me/KiteretsuZRobot), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
